...
namespace JevKrayPersonalSite.Migrations
{
    ...
    [Migration("20240323080116_update-projects-add-preview")]
    partial class updateprojectsaddpreview
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JevKrayPersonalSite.Models.CommitModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthorName = "test",
                            Date = new DateTimeOffset(new DateTime(2024, 3, 23, 11, 1, 16, 49, DateTimeKind.Unspecified).AddTicks(7289), new TimeSpan(0, 3, 0, 0, 0)),
